...
class WidgetDeviceSelectActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        widgetMode = intent.getStringExtra("widget_mode") ?: "1x3"
        ...
        btnConfirm.setOnClickListener {
            ...
            // Send broadcast to the widget provider
    ...
    inner class DeviceListAdapter(
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            val type = WidgetHelper.getDeviceType(this@WidgetDeviceSelectActivity, device.address)
